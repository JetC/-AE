...
namespace whu084
{
    public partial class InfrQuery : Form
    {
        private AxMapControl mMapControl;
        public InfrQuery(AxMapControl mapControl)
        {
            InitializeComponent();
        ...
        private void InfrQuery_Load(object sender, EventArgs e)
        {    
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbConnection conn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=I:\\SpfGISHelper\\whu084\\bin\\Debug\\App_Data\\实验.mdb");
